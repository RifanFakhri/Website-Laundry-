...
if(isset($_POST['btn-simpan'])){   
    ...
    if ($execute == 1) {
        ...
        $subtotal = $hargapaket['harga'] * $qty;
        $hasil_tambah = ($biaya_tambahan + $pajak + $subtotal);
        $hasil_diskon = $hasil_tambah - ($hasil_tambah * $diskon / 100);
        $total_harga  = $hasil_tambah - $hasil_diskon;
