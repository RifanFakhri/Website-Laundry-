...
"></i> Dashboard</a>
                        ...
                        <li>
                            <a href="pengguna.php"><i class="glyphicon glyphicon-floppy-save
"></i>User</a>
                        </li>
                        <li>
                            <a href="outlet.php"><i class="glyphicon glyphicon-floppy-open
"></i> Outlet</a>
                        </li>
                        <li>
...
"></i> Member</a>
                        ...
                        <li>
                            <a href="paket.php"><i class="glyphicon glyphicon-user
"></i> paket</a>
                        </li>
                        <li>
...
"></i> Transaksi</a>
                         ...
                         <li>
                            <a href="laporan.php"><i class="glyphicon glyphicon-user
"></i> Laporan</a>
                        </li>
                    </ul>
                </div>
